...
////등록//////////////////////////////////////////////////////////////////////////////////////
	...
	public void insertFile(Connection conn, FileVo fileVo) {
		...
		String sql = "insert into tb_file " + "(f_idx,type_idx,origin_file_name,rename_file_name,save_path) "
...
/////상세보기////////////////////////////////////////////////////////////////////////////////////////	
	...
	public List<FileVo> selectFileWithRegister(Connection conn, int carIdx) {
		...
		PreparedStatement pstm = null;
		ResultSet rs = null;
		String sql = "select " + "f_idx,type_idx,origin_file_name,rename_file_name,save_path,reg_date,is_del "
				+ "from tb_file " + "where type_idx = ?";
...
/////////수정/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public int updateRegister(Connection conn, Register register) {
		...
		try {
			String sql = "update tb_car set car_parking = ?,car_parking_lat = ?,car_parking_lng = ?,car_model = ?,car_number = ?,car_fuel_type = ?,car_fuel_effi = ?,car_navi = ?,car_back_cam = ?,car_seat_num = ?,car_door_num = ?,car_transmission = ?,car_fee = ?,car_note = ? where car_idx = ?";
