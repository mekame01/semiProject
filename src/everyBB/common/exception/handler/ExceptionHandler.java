package everyBB.common.exception.handler;
...
import everyBB.common.exception.CustomException;
...
public class ExceptionHandler extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//CustomException이 발생하면 /exception으로 요청이 재지정되어 해당 서블릿의 doGet이 호출
		//request 객체의 "javax.servlet.error.exception" 속성에 발생한 예외가 저장
		//Exception 객체를 반환받아서 해당 객체에 저장되어 있는 ErrorCode enum을 꺼내
